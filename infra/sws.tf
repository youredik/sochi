...
#
# =============================================================================
# PHASE B — DESTROY (this commit, after Phase A f28cc45 success)
# =============================================================================
#
# Sequence:
#   - Phase A (f28cc45, Run #121 success): restored SWS resources matching state
#     → API Gateway spec aligned (extension removed live + state) → ALB virtual
#     host auto-detached
#   - Phase B (this commit): remove SWS resources from config → destroy plan →
#     теперь orphan, destroy clean.
#
...
#   - apps/backend/src/lib/auth/captcha-gate.ts (SmartCaptcha + bypass token)
