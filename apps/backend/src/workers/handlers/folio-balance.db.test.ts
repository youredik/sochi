...
describe('folio_balance_writer — source disambiguation', () => {
...
describe('folio_balance_writer — trigger semantics', () => {
...
describe('folio_balance_writer — balance math (canon #12)', () => {
...
describe('folio_balance_writer — idempotency', () => {
...
describe('folio_balance_writer — cross-tenant isolation', () => {
...
describe('folio_balance_writer — field preservation', () => {
