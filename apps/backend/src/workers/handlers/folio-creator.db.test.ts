...
describe('folio_creator_writer — trigger semantics', () => {
...
describe('folio_creator_writer — payload correctness', () => {
...
describe('folio_creator_writer — idempotency', () => {
...
describe('folio_creator_writer — defensive guards', () => {
...
describe('folio_creator_writer — cross-tenant isolation', () => {
...
describe('folio_creator_writer — currency variants', () => {
