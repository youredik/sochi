...
describe('notification_writer — payment trigger semantics', () => {
...
describe('notification_writer — receipt trigger semantics', () => {
...
describe('notification_writer — idempotency', () => {
...
describe('notification_writer — outbox payload correctness', () => {
...
describe('notification_writer — cross-tenant isolation', () => {
