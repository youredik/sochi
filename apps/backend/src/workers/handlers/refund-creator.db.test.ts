...
describe('refund_creator_writer — trigger semantics', () => {
...
describe('refund_creator_writer — refund payload correctness', () => {
...
describe('refund_creator_writer — idempotency', () => {
...
describe('refund_creator_writer — defensive guards', () => {
...
describe('refund_creator_writer — money type parsing', () => {
...
describe('refund_creator_writer — cross-tenant isolation', () => {
