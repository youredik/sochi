...
describe('cancel_fee_writer — trigger semantics', () => {
...
describe('cancel_fee_writer — payload + balance', () => {
...
describe('cancel_fee_writer — idempotency', () => {
...
describe('cancel_fee_writer — defensive guards', () => {
...
describe('cancel_fee_writer — cross-tenant isolation', () => {
