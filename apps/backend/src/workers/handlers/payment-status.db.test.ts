...
describe('payment_status_writer — trigger semantics', () => {
...
describe('payment_status_writer — derivation correctness', () => {
...
describe('payment_status_writer — idempotency', () => {
...
describe('payment_status_writer — cross-tenant isolation', () => {
