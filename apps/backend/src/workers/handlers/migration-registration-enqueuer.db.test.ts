...
describe('migration_registration_enqueuer — trigger semantics', () => {
...
describe('migration_registration_enqueuer — defensive guards', () => {
...
describe('migration_registration_enqueuer — tenant config dependency', () => {
...
describe('migration_registration_enqueuer — document lookup', () => {
...
describe('migration_registration_enqueuer — payload correctness', () => {
...
describe('migration_registration_enqueuer — idempotency', () => {
...
describe('migration_registration_enqueuer — cross-tenant isolation', () => {
