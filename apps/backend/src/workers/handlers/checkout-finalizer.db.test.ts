...
describe('checkout_finalizer — trigger semantics', () => {
...
describe('checkout_finalizer — payload + math', () => {
...
describe('checkout_finalizer — idempotency', () => {
...
describe('checkout_finalizer — defensive guards', () => {
...
describe('checkout_finalizer — cross-tenant isolation', () => {
