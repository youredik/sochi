...
describe('dispatcher — skip filters', () => {
...
describe('dispatcher — permanent error', () => {
...
describe('dispatcher — transient retry', () => {
...
describe('dispatcher — cross-tenant', () => {
 ...
 */
describe('dispatcher — recipient resolution', () => {
