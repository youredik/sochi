...
describe('resolveRecipientEmail — booking source', () => {
...
describe('resolveRecipientEmail — payment source', () => {
...
describe('resolveRecipientEmail — receipt source', () => {
...
describe('resolveRecipientEmail — cross-tenant', () => {
