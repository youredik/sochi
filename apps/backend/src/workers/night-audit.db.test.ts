...
describe('runNightAudit — trigger semantics', () => {
...
describe('runNightAudit — payload + balance', () => {
...
describe('runNightAudit — idempotency', () => {
...
describe('runNightAudit — defensive guards', () => {
...
describe('runNightAudit — cross-tenant isolation', () => {
