...
describe('payment.service.createIntent — happy path', () => {
...
describe('payment.service.createIntent — folio validation', () => {
...
describe('payment.service.createIntent — idempotency', () => {
...
describe('payment.service — read methods + cross-tenant', () => {
