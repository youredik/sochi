...
describe('refund.service.create — happy path', () => {
...
describe('refund.service.create — cap invariant (canon #1)', () => {
...
describe('refund.service.create — SM gate', () => {
...
describe('refund.service.create — causality dedup', () => {
...
describe('refund.service — read methods cross-tenant', () => {
