...
describe('migrationRegistration.repo — create + getById', () => {
...
describe('migrationRegistration.repo — listByBooking', () => {
...
describe('migrationRegistration.repo — listPendingPoll', () => {
