...
describe('folio.service — happy path', () => {
...
describe('folio.service — FolioKind enum FULL coverage', () => {
...
describe('folio.service — cross-tenant isolation', () => {
...
describe('folio.service — currency / SM gates', () => {
