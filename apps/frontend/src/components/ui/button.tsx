...
const buttonVariants = cva(
  // Sprint C+ a11y audit 2026-05-23d: dropped `/50` opacity on focus ring —
  // WCAG 2.2 SC 2.4.13 Focus Appearance requires ≥3:1 contrast vs background;
  // /50 opacity reduced effective contrast to ~1.7:1. Solid `ring-ring` color
  // gives full 3:1 на neutral background.
